...
dialogs = [
    ...
    [
        ...
        ["I'm a amigo.", "I'm just a chatbot created in Python.", "Call me Amigo."]
    ],
    [
    ...
    [
        ...
        ["I don't have an age, but I was created by PHEONIX.", "I'm a relatively new creation, born in the realm of algorithms."]
    ],
    [
        r"thanks|thank you|nandri",
    ...
    [
        r"what is your name|who are you?",
        ["I'm a amigo.", "I'm just a chatbot created in Python."]
    ],
    [
    ...
    [
        r"luv uu|I love you|i think i am falling for you|i think i fel in love with you",
        ["luv u too.."]
    ],
    [
        r"tell me a riddle",
